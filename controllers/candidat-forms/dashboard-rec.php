...
<body>
  <div class="content-wrapper add-jobs active" id="content-wrapper-profile">
  ...
  <div class="content-wrapper" id="content-wrapper-hidden">
        ...
        <ul class="lists">
          <li class="list">
            <a href="#" id="profile-link" class="nav-link">
              ...
              <span class="link">Ajouter des postes</span>
            </a>
          </li>
          <li class="list">
            <a href="#" class="nav-link">
              <i class="bx bx-bar-chart-alt-2 icon"></i>
              <span class="link">Postes</span>
            </a>
          </li>
  ...
  <script src="/RecruitMe/public/javascript/dashboard-rec.js"></script>
</body>
