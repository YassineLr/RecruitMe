...
<head>
    ...
    <!-- "intl-tel-input" plugin and utils.js -->
        ...
        <div class="side-bar-container">
            ...
            <form class="row g-3 needs-validation formPers" action="/RecruitMe/controllers/candidat-forms/send-resume.php" method="POST" novalidate id="pers-form">
                ...
                <div class="container">
                        ...
                        <div class="email-num">
                            ...
                            <div class="col-md-4" style="width: 50%;">
                                ...
                                <div class="input-group">
                                    <input type="tel" id="phone" class="form-control" style="width: 100%;">
                        ...
                        <div class="row g-4 formEduc " id="educ-form">
                            ...
                            <div class="form-educ" id="edu-form-0">
                                ...
                                <div class="first-inputs">
                                    <div class="degree-city">
                                        <div class="col-md-4" style="width: 50%;">
                                            ...
                                            <select type="text" class="form-select" id="validationCustom01" required>
                                ...
                                <div class="col-md-4" style="width: 100%;">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" class="form-control" id="validationCustom" required data-ddg-inputtype="identities.addressCity">
                                ...
                                <div class="col-md-6" style="width: 100%;">
                                    ...
                                    <textarea type="textarea" class="form-control" id="validationCustom03"></textarea>
                        ...
                        <div class="row g-4 formExp " id="exp-form">
                            ...
                            <div class="form-exp" id="exp-form-0">
                                ...
                                <div class="col-md-6" style="width: 100%;">
                                    ...
                                    <textarea type="textarea" class="form-control" id="exp-desc"></textarea>
                    ...
                    <div class="final-sub">
                        <button class="btn btn-primary final-submit" type="submit">Suivant</button>
                    </div>
